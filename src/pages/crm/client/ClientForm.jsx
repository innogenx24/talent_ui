  ...
  return (
    <Box sx={{ p: { xs: 2, md: 5 } }}>
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 3, borderRadius: 2 }}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <Button variant="contained" startIcon={<Add />}>Add Address</Button>
              </Grid>
            </Grid>
          </Paper>
        </Grid>
        ...
        {/* Active Status (Below Other Information) */}
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 2, display: "flex", alignItems: "center", gap: 1, borderRadius: 2 }}>
