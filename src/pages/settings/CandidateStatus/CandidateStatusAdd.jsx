        ...
        <Grid item xs={12} md={5}>
          <Card>
            <CardContent>
              ...
              <TextField label="Status*" fullWidth margin="normal" placeholder="Enter Status" />
              <TextField label="Description" fullWidth margin="normal" multiline rows={3} placeholder="Enter Description" />
            </CardContent>
          </Card>
        </Grid>
