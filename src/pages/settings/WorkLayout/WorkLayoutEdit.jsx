        ...
        <Grid item xs={12} md={5}>
          <Card>
            <CardContent>
              ...
              <TextField label="Work Layout*" fullWidth margin="normal" defaultValue="Software Development" />
              <TextField
                label="Description"
                fullWidth
                margin="normal"
                multiline
                rows={3}
                defaultValue="This layout is used for managing software development tasks and projects."
              />
            </CardContent>
          </Card>
        </Grid>
